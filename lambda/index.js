...
const handlers = {
  ...
  GetJoke: function () {
    ...
    OpearloAnalytics.recordAnalytics(this.event.session.user.userId, process.env.API_KEY, () => {
...
exports.handler = (event, context) => {
  ...
  if (event.session.new) {
    OpearloAnalytics.initializeAnalytics(process.env.OPEARLO_USER_ID, 'joker', event.session);
  }
